...
const SingleProductPage: React.FC = () => {
  ...
  const toggleShippingAccordion = () => {
    setShippingAccordionOpen(!shippingAccordionOpen);
  };

  const toggleDetailsAccordion = () => {
    setDetailsAccordionOpen(!detailsAccordionOpen);
  };
          ...
          <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full lg:w-1/2 px-4">
              <div className="max-w-md mb-6">
                ...
                <h2 className="mt-6 mb-4 text-5xl md:text-xl lg:text-4xl font-heading font-medium">
              ...
              <div>
                ...
                <button
                  className="w-full pl-6 lg:pl-12 pr-6 py-4 mb-4 leading-7 rounded-2xl border-2 border-blueGray-200 hover:border-blueGray-300"
                ...
                >
                  ...
                  >
                    <p className="max-w-xl text-left mt-4 text-lg tracking-tighter text-gray-400">
                ...
                <button
                  className="w-full pl-6 lg:pl-12 pr-6 py-4 leading-7 rounded-2xl border-2 border-blueGray-200 hover:border-blueGray-300"
