...
const HeroSection = () => {
  return (
    ...
    <div className="parent flex h-96 sm:h-[600px]  bg-slate-200">
      <div className="div1 w-full hidden md:flex flex-grow-0 flex-shrink basis-52" style={{ }}>
      ...
      <div className="div2 flex flex-grow flex-shrink-0 basis-80 sm:basis-[600px] " 
      ...
      {/* most right */}
      <div
        className="  hidden lg:flex flex-col flex-grow-0 flex-shrink basis-96"
