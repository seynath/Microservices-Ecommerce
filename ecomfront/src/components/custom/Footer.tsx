            ...
            <div className="mb-4 w-full max-w-sm">
              ...
              >
                ...
                <input
                  type="submit"
                  value="Join"
                  className="sm:absolute right-0 top-0 inline-block h-full cursor-pointer bg-black px-6 py-2.5 text-center font-semibold text-white relative w-full sm:w-auto sm:right-0 rounded-tr-md rounded-br-md"
                />
              </form>
            </div>
          </div>
